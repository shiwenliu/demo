...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title>登录 - 个人博客</title>
    <link rel="stylesheet" href="<?php echo site_url('assets/css/oschina2011.css');?>" type="text/css" media="screen">
  <link rel="stylesheet" href="<?php echo site_url ('assets/css/thickbox.css" type="text/css')?>" media="screen">
  <link rel="stylesheet" href="<?php echo site_url ('assets/css/osc-popup.css');?>" type="text/css" media="screen">
...
<div class="MainForm" id="login_page">	
  <form id="frm_login" action="<?php echo site_url('user/dologin')?>" method="POST" style="float:left; width:620px;">
    <h2>登录个人博客，如果尚未加入的请点击<a href="<?php echo site_url('user/reg');?>">注册新会员</a></h2>
