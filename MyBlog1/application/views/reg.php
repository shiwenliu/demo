...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title>申请账号 - 个人博客</title>
    <link rel="stylesheet" href="<?php site_url('assets/css/oschina2011.css')?>" type="text/css" media="screen">
  <link rel="stylesheet" href="<?php site_url('assets/css/thickbox.css');?>" type="text/css" media="screen">
  <link rel="stylesheet" href="<?php site_url('assets/css/osc-popup.css');?>" type="text/css" media="screen">
  <script type="text/javascript" src="<?php echo site_url('assets/js/jquery-1.js');?>"></script>
  <script type="text/javascript" src="<?php echo site_url('assets/js/jquery.js');?>"></script>
  <script type="text/javascript" src="<?php echo site_url('assets/js/thickbox.js');?>"></script>
...
<form id="frm_reg" action="<?php echo site_url('user/doreg')?>" method="POST" style="float:left; width:620px;">
    <h2>申请<span style="color: #006600;"> SYSIT Blog</span> 账号，已经申请的请点击<a href="<?php echo site_url('user/login');?>">这里</a>登录</h2>
...
<script src="<?php echo site_url('assets/js/getcity.js');?>"></script><span class="nodisp">请选择您所在的地区</span></td>
    	</tr>
    	<tr class="buttons">
    		<th>&nbsp;</th>		
